...
EffDict = {
    ...
    "en": {
        ...
        "Mask": [["X", 0.0], ["Y", 0.0], ["Rotation", 0.00], ["Size", 100], ["rAspect", 0.0], ["Blur", 0],
                 ["Invert mask", 0, -1], ["Match with original size", 0, -1], ["type", 2, -2], ["name", ""],
                 ["mode", 0]],
        ...
        "Ripple": [["Center X", 0], ["Center Y", 0], ["Width", 30.0], ["Height", 15.0], ["Speed", 150],
                   ["num", 0, -2], ["interval", 0, -2], ["add", 0, -2]],
        "Displacement map": [["param0", 0.0], ["param1", 0.0], ["X", 0.0], ["Y", 0.0], ["Rotation", 0.00],
                             ["Size", 200],
                             ["rAspect", 0.0], ["Blur", 5], ["Match with original size", 0, -1],
                             ["type", 1, -2], ["name", "", -2], ["mode", 0, -2], ["calc", 0, -2]],
