...
EffDict = {
    ...
    "ja": {
        ...
        "シャドー": [["X", -40, 1], ["Y", 24, 1], ["濃さ", 40.0, 0.1], ["拡散", 10, 1], ["影を別オブジェクトで描画", 0, -1],
                 ["color", "000000", -2], ["file", "", -2]],
        ...
        "ノイズ": [["強さ", 100.0, 0.1], ["速度X", 0.0, 0.1], ["速度Y", 0.0, 0.1], ["変化速度", 0.0, 0.1],
                    ["周期X", 1.00, 0.01], ["周期Y", 1.00, 0.01], ["しきい値", 0.0, 0.1],
                   ["type", 0, -2], ["mode", 0, -2], ["seed", 0, -2]],
    ...
    "2": {
        ...
        "ドロップシャドウ": [["X", -40, 1], ["Y", 24, 1], ["濃さ", 40.0, 0.1], ["拡散", 10, 1],
                     ["影色", "000000", -2], ["影を別オブジェクトで描画", 0, -1]],
        "縁取り": [["サイズ", 5, 1], ["ぼかし", 5, 1], ["縁色", "ffffff", -2], ["パターン画像", "", -2]],
        ...
        "ノイズ": [["強さ", 100.0, 0.1], ["速度X", 0.0, 0.1], ["速度Y", 0.0, 0.1], ["変化速度", 0.0, 0.1],
                   ["周期X", 1.00, 0.01], ["周期Y", 1.00, 0.01], ["しきい値", 0.0, 0.1],
                   ["シード", 0, -2], ["合成モード", "アルファ値と乗算", -2], ["ノイズの種類", "Type1", -2] ],
    ...
    "en": {
        ...
        "Light": [["Strength", 100.0, 0.1], ["Diffusion", 25, 1], ["Ratio", 0.0, 0.1], ["Backlight", 0, -1],
                  ["color", "ffffff", -2]],
        "Shadow": [["X", -40, 1], ["Y", 24, 1], ["Thickness", 40.0, 0.1], ["Diffusion", 10, 1],
                     ["Draw shadow as separate object", 0, -1],
                     ["color", "000000", -2], ["file", "", -2]],
        ...
        "Displacement map": [["param0", 0.0, 0.1], ["param1", 0.0, 0.1], ["X", 0.0, 0.1], ["Y", 0.0, 0.1],
                             ...
                             ["type", 1, -2], ["name", "", -2], ["mode", 0, -2], ["calc", 0, -2]],
        "Noise": [["Strength", 100.0, 0.1], ["Speed X", 0.0, 0.1], ["Speed Y", 0.0, 0.1], ["dy/dx", 0.0, 0.1],
                   ["Cycle X", 1.00, 0.01], ["Cycle Y", 1.00, 0.01], ["Threshold", 0.0, 0.1],
                   ["type", 0, -2], ["mode", 0, -2], ["seed", 0, -2]],
    ...
    "zh": {
        ...
        "阴影": [["X", -40, 1], ["Y", 24, 1], ["浓度", 40.0, 0.1], ["扩散", 10, 1],
                   ["用另一个物件渲染阴影", 0, -1],
                   ["color", "000000", -2], ["file", "", -2]],
        ...
        "置换映射": [["param0", 0.0, 0.1], ["param1", 0.0, 0.1],
                          ...
                          ["type", 1, -2], ["name", "", -2], ["mode", 0, -2], ["calc", 0, -2]],
        "噪波": [["强度", 100.0, 0.1], ["速度X", 0.0, 0.1], ["速度Y", 0.0, 0.1], ["变化速度", 0.0, 0.1],
                  ["周期X", 1.00, 0.01], ["周期Y", 1.00, 0.01], ["阈值", 0.0, 0.1],
                  ["type", 0, -2], ["mode", 0, -2], ["seed", 0, -2]],
...
XDict = {
    ...
    "2": {
        "移動なし": "",
        "直線移動": "直線移動,0",
        "直線移動(時間制御)": "直線移動(時間制御),0",
        "補間移動": "補間移動,3",
        "補間移動(時間制御)": "補間移動(時間制御),0",
        "ランダム移動": "ランダム移動,4",
        "反復移動": "反復移動,4",
        "回転": "回転,4",
        "イージング（通常）": "イージング（通常）@イージング,0",
        },
    "ymm4": {
        "なし": "なし",
        "直線移動": "直線移動",
