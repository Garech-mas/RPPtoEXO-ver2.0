...
EffDict = {
    ...
    "ja": {
        ...
        #   タイプ: -1でチェックボックス、 -2でテキスト系   1, 0.1, 0.01でトラックバーの移動単位変更 (省略で自動的に0.1)
        ...
        "マスク": [["X", 0.0], ["Y", 0.0], ["回転", 0.00, 0.01], ["サイズ", 100, 1], ["縦横比", 0.0], ["ぼかし", 0, 1],
                ["マスクの反転", 0, -1], ["元のサイズに合わせる", 0, -1], ["type", 2, -2], ["name", ""], ["mode", 0]],
        "放射ブラー": [["範囲", 20.0], ["X", 0, 1], ["Y", 0, 1], ["サイズ固定", 0, -1]],
        "方向ブラー": [["範囲", 20, 1], ["角度", 50.0], ["サイズ固定", 0, -1]],
        "振動": [["X", 10, 1], ["Y", 10, 1], ["Z", 0, 1], ["周期", 1, 1], ["ランダムに強さを変える", 1, -1], ["複雑に振動", 0, -1]],
        "ミラー": [["透明度", 0.0], ["減衰", 0.0], ["境目調整", 0, 1], ["中心の位置を変更", 1, -1], ["type", 1, -2]],
        # type ミラー方向 上：0 下:1 左:2 右:3 中心位置変更のデフォは0
        "ラスター": [["横幅", 100, 1], ["高さ", 100, 1], ["周期", 1.00, 0.01], ["縦ラスター", 0, -1], ["ランダム振幅", 0, -1]],
        "波紋": [["中心X", 0, 1], ["中心Y", 0, 1], ["幅", 30.0], ["高さ", 15.0], ["速度", 150, 1],
               ["num", 0, -2], ["interval", 0, -2], ["add", 0, -2]],
        "ディスプレイスメントマップ": [["param0", 0.0], ["param1", 0.0], ["X", 0.0], ["Y", 0.0], ["回転", 0.00, 0.01],
                          ["サイズ", 200, 1], ["縦横比", 0.0], ["ぼかし", 5, 1], ["元のサイズに合わせる", 0, -1],
                          ["type", 1, -2], ["name", "", -2], ["mode", 0, -2], ["calc", 0, -2]],
        "色ずれ": [["ずれ幅", 5, 1], ["角度", 0.0], ["強さ", 100, 1], ["type", 0, -2]],
        "アニメーション効果": [["track0", 0.0], ["track1", 0.0], ["track2", 0.0], ["track3", 0.0],
    ...
    "en": {
        ...
        "Mask": [["X", 0.0], ["Y", 0.0], ["Rotation", 0.00, 0.01], ["Size", 100, 1], ["rAspect", 0.0],
                 ["Blur", 0, 1], ["Invert mask", 0, -1], ["Match with original size", 0, -1],
                 ["type", 2, -2], ["name", ""], ["mode", 0]],
        "Radial Blur": [["Range", 20.0], ["X", 0, 1], ["Y", 0, 1], ["Fixed Size", 0, -1]],
        "Direction blur": [["Range", 20, 1], ["Angle", 50.0], ["Fixed Size", 0, -1]],
        "Vibration": [["X", 10, 1], ["Y", 10, 1], ["Z", 0, 1], ["Period", 1, 1],
                      ["Change the strength at random", 1, -1], ["Complex vibration", 0, -1]],
        "Mirror": [["Clearness", 0.0], ["Attenuate", 0.0], ["dEdge", 0, 1],
        ...
        "Ripple": [["Center X", 0, 1], ["Center Y", 0, 1], ["Width", 30.0], ["Height", 15.0], ["Speed", 150, 1],
                   ["num", 0, -2], ["interval", 0, -2], ["add", 0, -2]],
        "Displacement map": [["param0", 0.0], ["param1", 0.0], ["X", 0.0], ["Y", 0.0], ["Rotation", 0.00, 0.01],
                             ["Size", 200, 1], ["rAspect", 0.0], ["Blur", 5, 1], ["Match with original size", 0, -1],
                             ["type", 1, -2], ["name", "", -2], ["mode", 0, -2], ["calc", 0, -2]],
        "Color shift": [["Gap width", 5, 1], ["Angle", 0.0], ["Strength", 100, 1], ["type", 0, -2]],
        "Animation effect": [["track0", 0.0], ["track1", 0.0], ["track2", 0.0], ["track3", 0.0],
